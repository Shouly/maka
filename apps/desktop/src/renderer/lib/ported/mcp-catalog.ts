...
const MCP_CATALOG_COPY = {
  ...
  'zh-TW': {
    dingtalk: {
      name: 'DingTalk',
      description: '管理聯絡人、行事曆、任務和協作資料。',
      category: '通訊',
      setupLabel: '需要 Client ID 和 Client Secret',
    },
    feishu: {
      name: '飛書',
      description: '存取飛書文件、行事曆、訊息和 OpenAPI。',
      category: '通訊',
      setupLabel: '需要 App ID 和 App Secret',
    },
    slack: {
      name: 'Slack',
      description: '傳送訊息、管理頻道，並在 Slack 工作區協作。',
      category: '通訊',
      setupLabel: '需要 Bot Token 和 Team ID',
    },
    line: {
      name: 'LINE',
      description: '透過 LINE Bot Messaging API 傳送和管理訊息。',
      category: '通訊',
      setupLabel: '需要 Channel Access Token',
    },
    notion: {
      name: 'Notion',
      description: '搜尋、讀取和更新 Notion 工作區。',
      category: '知識與文件',
      setupLabel: '需要登入授權',
    },
    'macos-apps': {
      name: 'macOS 應用程式',
      description: '透過原生系統權限連接「行事曆」與「提醒事項」。',
      category: '系統與生產力',
      setupLabel: undefined,
    },
    'google-calendar': {
      name: 'Google 日曆',
      description: '管理活動、建立會議並檢查可用時間。',
      category: '系統與生產力',
      setupLabel: '需要 OAuth 憑證檔案',
    },
    figma: {
      name: 'Figma',
      description: '讀取設計檔案、元件和開發交付資料。',
      category: '設計與開發',
      setupLabel: '需要 Personal Access Token',
    },
    vercel: {
      name: 'Vercel',
      description: '檢查專案、部署、記錄和平台文件。',
      category: '設計與開發',
      setupLabel: '需要登入授權',
    },
    supabase: {
      name: 'Supabase',
      description: '管理資料庫、專案設定、移轉和 Edge Functions。',
      category: '設計與開發',
      setupLabel: '需要登入授權',
    },
    filesystem: {
      name: '本機檔案',
      description: '在選取的資料夾中安全地讀取、寫入和管理檔案。',
      category: '檔案與知識',
      setupLabel: '需要選擇允許存取的資料夾',
    },
    memory: {
      name: '持久記憶',
      description: '使用結構化知識圖譜記住實體、關係和重要事實。',
      category: '檔案與知識',
      setupLabel: undefined,
    },
    playwright: {
      name: '瀏覽器自動化',
      description: '讓 Maka 透過 Playwright 讀取和操作實際網頁。',
      category: '設計與開發',
      setupLabel: undefined,
    },
    'sequential-thinking': {
      name: '循序思考',
      description: '為複雜問題提供可修正、可驗證的結構化推理。',
      category: '推理與規劃',
      setupLabel: undefined,
    },
  },
  en: {
    dingtalk: {
      name: 'DingTalk',
      description: 'Manage contacts, calendars, tasks, and collaboration data.',
      category: 'Communication',
      setupLabel: 'Requires Client ID and Client Secret',
    },
    feishu: {
      name: 'Feishu',
      description: 'Access Feishu documents, calendars, messages, and OpenAPI.',
      category: 'Communication',
      setupLabel: 'Requires App ID and App Secret',
    },
    slack: {
      name: 'Slack',
      description: 'Send messages, manage channels, and collaborate in a Slack workspace.',
      category: 'Communication',
      setupLabel: 'Requires Bot Token and Team ID',
    },
    line: {
      name: 'LINE',
      description: 'Send and manage messages through the LINE Bot Messaging API.',
      category: 'Communication',
      setupLabel: 'Requires Channel Access Token',
    },
    notion: {
      name: 'Notion',
      description: 'Search, read, and update a Notion workspace.',
      category: 'Knowledge and documents',
      setupLabel: 'Requires sign-in authorization',
    },
    'macos-apps': {
      name: 'macOS apps',
      description: 'Connect Calendar and Reminders through native system permissions.',
      category: 'System and productivity',
      setupLabel: undefined,
    },
    'google-calendar': {
      name: 'Google Calendar',
      description: 'Manage events, create meetings, and check availability.',
      category: 'System and productivity',
      setupLabel: 'Requires an OAuth credentials file',
    },
    figma: {
      name: 'Figma',
      description: 'Read design files, components, and developer handoff data.',
      category: 'Design and development',
      setupLabel: 'Requires a Personal Access Token',
    },
    vercel: {
      name: 'Vercel',
      description: 'Inspect projects, deployments, logs, and platform documentation.',
      category: 'Design and development',
      setupLabel: 'Requires sign-in authorization',
    },
    supabase: {
      name: 'Supabase',
      description: 'Manage databases, project configuration, migrations, and Edge Functions.',
      category: 'Design and development',
      setupLabel: 'Requires sign-in authorization',
    },
    filesystem: {
      name: 'Local files',
      description: 'Safely read, write, and manage files in selected directories.',
      category: 'Files and knowledge',
      setupLabel: 'Requires selecting allowed directories',
    },
    memory: {
      name: 'Persistent memory',
      description:
        'Remember entities, relationships, and important facts in a structured knowledge graph.',
      category: 'Files and knowledge',
      setupLabel: undefined,
    },
    playwright: {
      name: 'Browser automation',
      description: 'Let Maka read and operate real web pages through Playwright.',
      category: 'Design and development',
      setupLabel: undefined,
    },
    'sequential-thinking': {
      name: 'Sequential thinking',
      description: 'Provide revisable, verifiable structured reasoning for complex problems.',
...
export function catalogEntryMatches(entry: McpCatalogEntry, normalizedQuery: string): boolean {
  ...
  return [entry.id, entry.name, entry.description, entry.category, ...(entry.aliases ?? [])].some(
