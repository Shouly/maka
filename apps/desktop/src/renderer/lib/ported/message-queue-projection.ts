...
import type { MessageQueueEntryProjection, QueueUpdateEvent } from '@maka/core/events';
...
export function deriveMessageQueueProjection(event: QueueUpdateEvent): MessageQueueProjection {
