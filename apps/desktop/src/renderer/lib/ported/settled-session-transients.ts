...
// Ported verbatim from upstream `renderer/settled-session-transients.ts`
// (#646). Which sessions' turn transients the authority says are over.
 ...
 * send just created, taking the whole first-token wait with it.
 *
 ...
 * and no session-level status may be read as an answer.
 */
