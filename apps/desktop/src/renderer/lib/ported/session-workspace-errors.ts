...
// Ported from upstream `renderer/session-workspace-errors.ts`. A Session whose
// project directory is gone fails every Host action with one typed code; the
// user is told that, not handed the raw error string.
