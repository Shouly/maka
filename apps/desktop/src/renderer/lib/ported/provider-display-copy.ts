...
export const PROVIDER_DISPLAY_COPY = {
  ...
  'minimax-coding-plan': {
    ...
    'zh-TW': {
      name: 'MiniMax Coding Plan',
      description: 'MiniMax Coding 套餐 · Anthropic 相容',
      badge: 'Coding',
    },
    en: {
      name: 'MiniMax Coding Plan',
  ...
  'MiniMax-cn': {
    ...
    'zh-TW': {
      name: 'MiniMax 中國站',
      description: 'MiniMax 中國站 · Anthropic 相容',
      badge: 'API',
    },
    en: {
      name: 'MiniMax China',
  ...
  siliconflow: {
    ...
    'zh-TW': {
      name: 'SiliconFlow',
      description: '矽基流動多模型 API，支援精確模型 ID。',
      badge: '聚合',
    },
    en: {
      name: 'SiliconFlow',
  ...
  'xiaomi-token-plan-cn': {
    ...
    'zh-TW': {
      name: 'Xiaomi Token Plan 中國',
      description: '小米 MiMo Token Plan 訂閱 · 中國 · 編碼工具',
      badge: 'Token',
    },
    en: {
  ...
  'xiaomi-token-plan-sgp': {
    ...
    'zh-TW': {
      name: 'Xiaomi Token Plan 新加坡',
      description: '小米 MiMo Token Plan 訂閱 · 新加坡 · 編碼工具',
      badge: 'Token',
    },
    en: {
  ...
  'xiaomi-token-plan-ams': {
    ...
    'zh-TW': {
      name: 'Xiaomi Token Plan 歐洲',
      description: '小米 MiMo Token Plan 訂閱 · 歐洲 · 編碼工具',
      badge: 'Token',
    },
    en: {
  ...
  'openai-compatible': {
    ...
    'zh-TW': {
      name: '自訂中轉站（OpenAI Chat）',
      description: 'OpenAI Chat Completions 相容中轉站、代理服務或自部署閘道器。',
      badge: '中轉',
    },
    en: {
  ...
  'openai-responses-compatible': {
    ...
    'zh-TW': {
      name: '自訂中轉站（OpenAI Responses）',
      description: 'OpenAI Responses API 相容中轉站、代理服務或自部署閘道器。',
      badge: 'Responses',
    },
    en: {
  ...
  'anthropic-compatible': {
    ...
    'zh-TW': {
      name: '自訂中轉站（Anthropic）',
      description: 'Anthropic Messages 相容中轉站、代理服務或自部署閘道器。',
      badge: 'Anthropic',
    },
    en: {
  ...
  'tencent-tokenhub': {
    ...
    'zh-TW': {
      name: 'Tencent TokenHub',
      description: '騰訊雲 TokenHub 按量計費模型服務，包含混元等模型',
      badge: 'API',
    },
    en: {
      name: 'Tencent TokenHub',
  ...
  'tencent-coding-plan': {
    ...
    'zh-TW': {
      name: 'Tencent Coding Plan',
      description: '騰訊雲 Coding 套餐 · OpenAI 相容',
      badge: 'Coding',
    },
    en: {
      name: 'Tencent Coding Plan',
  ...
  'volcengine-ark': {
    ...
    'zh-TW': {
      name: '火山方舟',
      description: '火山引擎官方 API 連線，包含豆包等模型',
      badge: 'API',
    },
    en: {
  ...
  'volcengine-coding-plan': {
    ...
    'zh-TW': {
      name: '火山方舟 Coding Plan',
      description: '火山引擎 Coding 訂閱 · OpenAI 相容',
      badge: 'Coding',
    },
    en: {
  ...
  'volcengine-agent-plan': {
    ...
    'zh-TW': {
      name: '火山方舟 Agent Plan',
      description: '火山引擎 Agent 訂閱 · Responses API',
      badge: 'Agent',
    },
    en: {
  ...
  'tencent-token-plan': {
    ...
    'zh-TW': {
      name: 'Tencent Token Plan',
      description: '騰訊雲 Token 套餐，個人智慧體與編碼工具',
      badge: 'Token',
    },
    en: {
      name: 'Tencent Token Plan',
  ...
  'stepfun-step-plan': {
    ...
    'zh-TW': {
      name: 'StepFun Step Plan 中國站',
      description: '階躍星辰訂閱套餐 · 中國站',
      badge: 'Plan',
    },
    en: {
  ...
  'stepfun-ai-step-plan': {
    ...
    'zh-TW': {
      name: 'StepFun Step Plan 國際站',
      description: '階躍星辰訂閱套餐 · 國際站',
      badge: 'Plan',
    },
    en: {
  ...
  'cloudflare-workers-ai': {
    ...
    'zh-TW': {
      name: 'Cloudflare Workers AI',
      description: 'Cloudflare 託管模型，使用帳號層級連線',
      badge: 'API',
    },
    en: {
      name: 'Cloudflare Workers AI',
  ...
  huggingface: {
    ...
    'zh-TW': {
      name: 'Hugging Face',
      description: 'Inference Providers 路由，聚合多家託管模型',
      badge: '路由',
    },
    en: {
      name: 'Hugging Face',
  ...
  zenmux: {
    ...
    'zh-TW': {
      name: 'ZenMux',
      description: '模型路由閘道器，使用一組金鑰連線多家模型',
      badge: '閘道器',
    },
    en: {
      name: 'ZenMux',
  ...
  commandcode: {
    'zh-CN': {
      name: 'Command Code',
      description: '使用 Command Code 套餐额度，连接后自动获取模型。',
      badge: 'Coding',
    },
    'zh-TW': {
      name: 'Command Code',
      description: '使用 Command Code 方案額度，連線後自動取得模型。',
      badge: 'Coding',
    },
    en: {
      name: 'Command Code',
      description: 'Use your Command Code plan credits. Models are fetched when you connect.',
      badge: 'Coding',
    },
  },
  groq: {
  ...
  openrouter: {
    ...
    'zh-TW': {
      name: 'OpenRouter',
      description: '使用一組金鑰連線各大模型廠商 · OpenAI 相容',
      badge: '聚合',
    },
    en: {
      name: 'OpenRouter',
  ...
  alibaba: {
    ...
    'zh-TW': {
      name: 'Alibaba',
      description: '阿里雲百鍊 API 連線，支援通義千問 Qwen 模型',
      badge: 'API',
    },
  ...
  'alibaba-cn': {
    ...
    'zh-TW': {
      name: 'Alibaba 中國站',
      description: '阿里雲百鍊中國站 API 連線，支援通義千問 Qwen 模型',
      badge: 'API',
    },
    en: {
      name: 'Alibaba (China)',
  ...
  'alibaba-coding-plan-cn': {
    ...
    'zh-TW': {
      name: 'Alibaba Coding Plan 中國站',
      description: '阿里雲百鍊 Coding Plan 訂閱 · 中國站',
      badge: 'Plan',
    },
    en: {
  ...
  'alibaba-coding-plan': {
    ...
    'zh-TW': {
      name: 'Alibaba Coding Plan 國際站',
      description: '阿里雲百鍊 Coding Plan 訂閱 · 國際站',
      badge: 'Plan',
    },
    en: {
  ...
  'alibaba-token-plan-cn': {
    ...
    'zh-TW': {
      name: 'Alibaba Token Plan（團隊版）',
      description: '阿里雲百鍊 Token Plan 訂閱，互動式智慧體與編碼工具 · 北京',
      badge: 'Token',
    },
    en: {
  ...
  'alibaba-token-plan': {
    ...
    'zh-TW': {
      name: 'Alibaba Token Plan（團隊版）',
      description: '阿里雲百鍊 Token Plan 訂閱，互動式智慧體與編碼工具 · 新加坡',
      badge: 'Token',
    },
    en: {
  ...
  'github-copilot': {
    ...
    'zh-TW': {
      name: 'GitHub Copilot',
      description: '透過 GitHub Copilot 訂閱連線，沿用本機 GitHub 登入',
      badge: 'Account',
    },
    en: {
      name: 'GitHub Copilot',
  ...
  'claude-subscription': {
    ...
    'zh-TW': {
      name: 'Claude Subscription',
      description: 'Claude Pro / Max 訂閱帳號登入；登入後自動成為可用模型連線。',
    },
    en: {
      name: 'Claude Subscription',
      description:
  ...
  'openai-codex': {
    ...
    'zh-TW': {
      name: 'OpenAI OAuth',
      description: 'ChatGPT / Codex 帳號登入；登入後自動成為可用模型連線。',
    },
    en: {
      name: 'OpenAI OAuth',
      description:
  ...
  'xai-oauth': {
    ...
    'zh-TW': {
      name: 'xAI OAuth',
      description: '使用 SuperGrok 或 X Premium 帳號登入。',
      badge: 'Account',
    },
    en: {
      name: 'xAI OAuth',
...
export function providerDisplay(type: ProviderType, locale: UiLocale): ProviderCopy {
  const copy = (PROVIDER_DISPLAY_COPY as Partial<Record<string, UiCatalog<ProviderCopy>>>)[type]?.[
    locale
  ];
