...
// Ported verbatim from the pre-rewrite `renderer/mcp-command-line.ts`.
//
// The editor's single command field holds a whole command line; mcp.json keeps
...
// operators. Whitespace separates tokens; single or double quotes group spans
// containing whitespace; inside double quotes, `\"` and `\\` escape.
