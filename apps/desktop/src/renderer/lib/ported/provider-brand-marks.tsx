...
/**
 * Google's four-colour "G", for the "Continue with Google" sign-in button.
 * The same mark relx-copilot's login uses (`frontend/public/icons/
 * google-icon.svg`), from gilbarbara/logos `logos/google-icon.svg` (CC0 1.0);
 * the mark itself is Google's and only names the sign-in provider.
 */
export function GoogleSignInMark(props: { className?: string }): ReactElement {
  return (
    <svg
