...
// Scheduled tasks, read only for the sidebar's Automations badge.
//
// The module page itself is Phase 5. What the shell needs now is the count of
// tasks that are armed and will fire — a number the user should see without
// opening anything, because an automation nobody remembers arming is the one
// that surprises them.
