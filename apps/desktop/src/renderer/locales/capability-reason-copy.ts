...
const CAPABILITY_REASON_COPY = {
  ...
  'zh-TW': {
    ...
    notifications_status_unreadable_macos:
      'Electron 無法可靠讀取 macOS 通知授權狀態，請在系統設定中確認',
  ...
  en: {
    ...
    apple_events_tcc_status_unavailable:
      'Electron cannot read per-app Apple Events authorization status',
    ...
    screen_recording_status_mac_only:
      'Screen Recording permission status can only be read on macOS',
    notifications_status_unreadable_macos:
      'Electron cannot reliably read macOS notification authorization; check System Settings',
    notifications_status_unreadable:
      'Electron cannot reliably read notification authorization on this system',
