...
type MemoryTextKey =
  ...
  | 'restoreAction'
  | 'archiveAction'
  // Enterprise (Phase 5b): the reset confirmation dialog.
  | 'resetConfirmTitle'
...
const zhTwText = {
  localFile: '本地 MEMORY.md',
  localFileHelp: '透明 Markdown 檔案，儲存在目前本機工作區。這裡的內容不會自動從聊天裡抽取。',
  enableLocalFile: '啟用本地 MEMORY.md',
  agentReadable: '模型上下文可讀取',
  agentReadableHelp:
    '預設關閉。開啟後，傳送訊息時會把本地記憶一併提供給模型；隱身模式下仍然不提供。',
  enableAgentRead: '允許模型上下文讀取本地記憶',
  waitingFile: '等待建立 MEMORY.md',
  waitingBackup: '等待生成上一版備份',
  dirty: '有未儲存修改',
  savedDraft: '草稿已儲存',
  backupCandidates: '備份候選',
  backupCandidatesAria: '本地記憶備份候選列表',
  opening: '開啟中…',
  open: '開啟',
  restoring: '恢復中…',
  restore: '恢復',
  copying: '複製中…',
  copyReference: '複製引用',
  backupHelp: '上一版操作會使用最近的候選；這裡只顯示 metadata，不展示備份正文。',
  savedAt: '儲存於 ',
  previewPaused: '草稿條目預覽暫停',
  filterAria: '篩選本地記憶',
  filterPlaceholder: '篩選標題、內容、ID 或標籤',
  clear: '清除',
  filterEmpty: '沒有符合的記憶條目',
  filterEmptyHelp: '篩選不會修改 MEMORY.md；清除篩選後會恢復顯示全部條目。',
  activeMemories: '生效記憶',
  archivedMemories: '已歸檔記憶',
  waitingEntry: '等待新增記憶條目',
  waitingEntryHelp: '在任務裡確認記憶，或點右上角「新增記憶」。',
  manualAddAria: '手動新增本地記憶',
  manualAdd: '手動新增記憶',
  manualAddHelp: '填寫後立即寫入本機 MEMORY.md。',
  title: '記憶標題',
  titlePlaceholder: '標題',
  tags: '記憶標籤',
  tagsPlaceholder: '標籤（逗號分隔，可選）',
  content: '記憶內容',
  contentPlaceholder: '內容',
  addDraft: '新增記憶',
  sensitiveDraft: '草稿含疑似敏感欄位',
  sensitiveDraftHelp: '儲存時會先遮蔽疑似 token、API key 或密碼，再寫入 MEMORY.md。',
  fileContent: 'MEMORY.md 內容',
  fileActionsAria: 'MEMORY.md 檔案操作',
  saving: '儲存中…',
  save: '儲存',
  saved: '已儲存',
  openFile: '開啟 MEMORY.md',
  openFolder: '開啟所在目錄',
  loading: '載入中…',
  reload: '重新載入',
  openPrevious: '開啟上一版',
  ...
  created: '建立 ',
  updated: '更新 ',
  archivedNoPrompt: '已歸檔，不會提供給模型',
  activePrompt: '生效條目，傳送時會提供給模型',
  locateDraft: '定位草稿',
  promptPreview: '模型上下文預覽',
  willInject: '傳送時會提供',
  willNotInject: '目前不會提供',
  copyContext: '複製上下文',
  promptPreviewHelp: '這裡是傳送時會提供給模型的內容；已歸檔條目不在其中，疑似金鑰會遮蔽。',
  safeModePreview: 'MEMORY.md 過大，目前不會生成模型上下文預覽。',
  emptyPromptPreview: '沒有生效記憶會提供給模型。',
  loadFailed: '載入本地記憶失敗',
  reloaded: '已重新載入 MEMORY.md',
  reloadDiscarded: '未儲存的草稿修改已丟棄。',
  toggleFailed: '更新本地記憶開關失敗',
  agentReadFailed: '更新模型讀取權限失敗',
  saveBlocked: '儲存被攔截',
  safeMode: 'MEMORY.md 內容過大，已進入安全模式。',
  savedRedacted: '已儲存並遮蔽敏感欄位',
  savedFile: '已儲存 MEMORY.md',
  saveFailed: '儲存 MEMORY.md 失敗',
  resetDone: '已重置 MEMORY.md',
  resetDoneDetail: '上一版已儲存為備份檔案。',
  resetFailed: '重置 MEMORY.md 失敗',
  noBackup: '沒有可恢復備份',
  noBackupDetail: '儲存或重置 MEMORY.md 後才會生成上一版備份。',
  restoreLatestTitle: '恢復上一版 MEMORY.md？',
  restoreCandidateTitle: '恢復這個 MEMORY.md 備份？',
  confirmRestore: '恢復',
  cancel: '取消',
  restoredLatest: '已恢復上一版 MEMORY.md',
  restoredCandidate: '已恢復 MEMORY.md 備份候選',
  restoredDetail: '恢復前的目前檔案已儲存為 restore.bak。',
  restoreFailed: '恢復失敗',
  restoreLatestFailed: '恢復上一版失敗',
  restoreCandidateFailed: '恢復備份失敗',
  openFailed: '開啟失敗',
  openPreviousFailed: '開啟上一版失敗',
  pathCopied: '已複製路徑',
  copyFailed: '複製失敗',
  copyFailedDetail: '剪貼簿不可用或被系統拒絕。',
  backupReferenceCopied: '已複製上一版引用',
  entryReferenceCopied: '已複製記憶引用',
  locateFailed: '無法定位記憶',
  locateFailedDetail: '目前草稿裡找不到這條記憶；請先儲存或重新整理後重試。',
  emptyTitle: '標題不能為空',
  emptyTitleDetail: '給這條記憶起一個短標題。',
  emptyContent: '內容不能為空',
  emptyContentDetail: '寫下要保留的偏好或事實。',
  draftOversize: '草稿過大',
  oversizeDetail: 'MEMORY.md 超出安全上限，請先刪減舊內容。',
  addedDraft: '已新增記憶',
  addedDraftDetail: '已寫入 MEMORY.md。',
  updateFailed: '無法更新記憶',
  invalidIdDetail: '這條記憶沒有可識別 ID，已停止更新。',
  archivedDraft: '已在草稿中歸檔記憶',
  restoredDraft: '已在草稿中恢復記憶',
  updateBlocked: '更新被攔截',
  archived: '已歸檔記憶',
  restored: '已恢復記憶',
  archiveFailed: '歸檔記憶失敗',
  entryRestoreFailed: '恢復記憶失敗',
  promptCopied: '已複製模型上下文預覽',
  promptCopiedDetail: '使用同一條 prompt 預覽和遮蔽路徑。',
  restoreDraftAction: '恢復到草稿',
  archiveDraftAction: '歸檔到草稿',
  restoreAction: '恢復',
  archiveAction: '歸檔',
  resetConfirmTitle: '重置 MEMORY.md？',
...
const enText = {
  ...
  sensitiveDraftHelp:
    'Suspected tokens, API keys, and passwords are redacted before MEMORY.md is written.',
...
const SETTINGS_MEMORY_COPY = {
  'zh-CN': {
    ...
    saveSummary: (active, archived) =>
      archived > 0
        ? `当前 ${active} 条生效 / ${archived} 条已归档；已保留上一版备份。`
        : `当前 ${active} 条生效；已保留上一版备份。`,
    backupSummary: (active, archived) =>
      archived > 0 ? `${active} 条生效 / ${archived} 条已归档` : `${active} 条生效`,
    ...
    restoreLatestDescription: (label) =>
      `会先备份当前 MEMORY.md，再用最近一次备份覆盖当前文件。将恢复：${label}`,
    restoreCandidateDescription: (label) =>
    ...
    results: {
      no_backup: '当前没有可用的 MEMORY.md 备份。',
      invalid_backup_kind: '备份类型无法识别。',
      memory_unavailable: '本地记忆服务当前不可用。',
      backup_not_found: '找不到对应的备份文件。',
      remote_host_owned: '记忆文件由远程 Runtime Host 管理，无法在本机打开。',
      not_regular_file: '记忆路径不是允许打开的常规文件。',
      open_failed: '系统无法打开记忆文件。',
      file_not_found: '找不到记忆文件。',
      disabled: '本地记忆已关闭。',
      incognito_active: '隐身模式下不可用。',
      safe_mode: 'MEMORY.md 内容过大，已进入安全模式。',
      oversize: 'MEMORY.md 超出安全上限，请先删减旧内容。',
      revision_conflict: '记忆内容刚被其他操作修改，请重试。',
      backup_revision_conflict: '备份内容刚被其他操作修改，请重试。',
      invalid_state: 'Runtime Host 返回了无效的记忆状态。',
      invalid_content: 'MEMORY.md 内容无效，请检查格式后重试。',
      invalid_scope: '当前记忆操作的作用域无效。',
      not_found: '找不到对应的记忆条目。',
      not_pending: '对应的记忆条目不在待确认状态。',
      upload_not_found: '记忆上传会话不存在或已过期。',
      upload_incomplete: '记忆内容尚未上传完整。',
    ...
    backupKinds: { reset: '重置前备份', restore: '恢复前备份', save: '保存前备份' },
    memoryStatuses: {
      ok: '本地文件已就绪',
      disabled: '已关闭',
      safe_mode: '安全模式',
  ...
  'zh-TW': {
    ...
    backupSummary: (active, archived) =>
      archived > 0 ? `${active} 則生效 / ${archived} 則已歸檔` : `${active} 則生效`,
    ...
    restoreLatestDescription: (label) =>
      `會先備份目前的 MEMORY.md，再以最近一次備份覆蓋目前檔案。將還原：${label}`,
    restoreCandidateDescription: (label) =>
    ...
    results: {
      no_backup: '目前沒有可用的 MEMORY.md 備份。',
      invalid_backup_kind: '備份類型無法識別。',
      memory_unavailable: '本機記憶服務目前無法使用。',
      backup_not_found: '找不到對應的備份檔案。',
      remote_host_owned: '記憶檔案由遠端 Runtime Host 管理，無法在本機開啟。',
      not_regular_file: '記憶路徑不是允許開啟的一般檔案。',
      open_failed: '系統無法開啟記憶檔案。',
      file_not_found: '找不到記憶檔案。',
      disabled: '本機記憶已關閉。',
      incognito_active: '隱身模式下無法使用。',
      safe_mode: 'MEMORY.md 內容過大，已進入安全模式。',
      oversize: 'MEMORY.md 超出安全上限，請先刪減舊內容。',
      revision_conflict: '記憶內容剛被其他操作修改，請重試。',
      backup_revision_conflict: '備份內容剛被其他操作修改，請重試。',
      invalid_state: 'Runtime Host 回傳了無效的記憶狀態。',
      invalid_content: 'MEMORY.md 內容無效，請檢查格式後重試。',
      invalid_scope: '目前記憶操作的作用域無效。',
      not_found: '找不到對應的記憶條目。',
      not_pending: '對應的記憶條目不在待確認狀態。',
      upload_not_found: '記憶上傳工作階段不存在或已過期。',
      upload_incomplete: '記憶內容尚未上傳完整。',
    ...
    backupKinds: { reset: '重置前備份', restore: '恢復前備份', save: '儲存前備份' },
    memoryStatuses: {
      ok: '本地檔案已就緒',
      disabled: '已關閉',
      safe_mode: '安全模式',
      incognito_blocked: '隱身停用',
      error: '讀取失敗',
    },
    promptBlocked: {
      disabled: '本地記憶已關閉。',
      incognito: '隱身模式下不會提供本地記憶。',
      safeMode: 'MEMORY.md 過大，目前不會提供。',
      agentRead: '模型上下文讀取未開啟。',
    },
    backupOversize: '備份過大，無法預覽條目',
    previewOversize: '草稿過大，條目預覽已暫停；儲存前請先刪減 MEMORY.md 內容。',
    previewTruncationMarker: '[本地記憶已按長度截斷]',
  },
  en: {
    intlLocale: 'en-US',
    text: enText,
    countActive: (count, draft) =>
      draft
        ? `Draft · ${count} active ${count === 1 ? 'entry' : 'entries'}`
        : `${count} active ${count === 1 ? 'entry' : 'entries'}`,
    countArchived: (count, draft) =>
      draft
    ...
    restoreLatestDescription: (label) =>
      `The current MEMORY.md will be backed up before the latest backup replaces it. Restore: ${label}`,
    restoreCandidateDescription: (label) =>
      `The current MEMORY.md will be backed up before the selected backup replaces it. Restore: ${label}`,
    redactedDetail: (summary) =>
      `Suspected tokens, API keys, or passwords were redacted before writing; ${summary}`,
    ...
    results: {
      no_backup: 'No MEMORY.md backup is available.',
      invalid_backup_kind: 'Unrecognized backup kind.',
      memory_unavailable: 'Local memory is currently unavailable.',
      backup_not_found: 'The backup file was not found.',
      remote_host_owned:
        'Memory files are owned by the remote Runtime Host and cannot be opened locally.',
      not_regular_file: 'The memory path is not an allowed regular file.',
      open_failed: 'The system could not open the memory file.',
      file_not_found: 'The memory file was not found.',
      disabled: 'Local memory is disabled.',
      incognito_active: 'Unavailable in incognito mode.',
      safe_mode: 'MEMORY.md is too large and entered safe mode.',
      oversize: 'MEMORY.md exceeds the safety limit. Remove older content first.',
      revision_conflict: 'Memory was just changed by another operation. Try again.',
      ...
      invalid_content: 'MEMORY.md content is invalid. Check its format and try again.',
      invalid_scope: 'The memory operation has an invalid scope.',
      not_found: 'The memory entry was not found.',
      not_pending: 'The memory entry is not pending review.',
      upload_not_found: 'The memory upload session does not exist or has expired.',
      upload_incomplete: 'The memory content has not finished uploading.',
    ...
    backupKinds: { reset: 'Before reset', restore: 'Before restore', save: 'Before save' },
    memoryStatuses: {
      ok: 'Local file ready',
      disabled: 'Off',
      safe_mode: 'Safe mode',
    ...
    previewOversize:
      'The draft is too large, so entry preview is paused. Reduce MEMORY.md before saving.',
