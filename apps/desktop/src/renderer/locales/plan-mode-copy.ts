...
const COPY = {
  ...
  en: {
    ...
    controlFailure: {
      ...
      session_busy:
        'A task is running in this Session. Wait for it to finish before changing the plan.',
    ...
    abandonConfirmation: {
      ...
      description: (title) =>
        `The execution record for “${title}” will remain, but it cannot be resumed.`,
      confirm: 'Abandon plan',
      cancel: 'Cancel',
    },
    proposal: {
      aria: 'Plan proposal',
      kicker: 'Plan proposal',
      revision: 'Revision',
      steps: 'Steps',
      risks: 'Risks',
