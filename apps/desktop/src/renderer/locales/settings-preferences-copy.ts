...
const SETTINGS_PREFERENCES_COPY_BY_LOCALE = {
  'zh-CN': {
    ...
    sections: {
      ...
      palette: '调色板',
      paletteHelp: '强调色与画布色调；切换会立即生效并保存在本地。',
      appIcon: '应用图标',
    ...
    appearance: {
      ...
      appIconHelp: {
        ...
        cyan: '偏青的蓝',
        ice: '由浅到深的蓝色渐变',
        'pale-inverted': '淡蓝底配深蓝标',
        ink: '黑底白标，对比最强',
        paper: '白底黑标',
        graphite: '白底黑标，笔尖为灰',
        'pencil-kraft': '铅笔意象，牛皮纸底',
        'pencil-sky': '铅笔意象，天蓝底',
        'pencil-navy': '铅笔意象，深蓝底',
        alpine: '雪顶山峰，晴空底',
        dusk: '雪顶山峰，黄昏底',
        night: '雪顶山峰，夜色底',
        midnight: '深蓝底配亮蓝标，深色 Dock 里仍有轮廓',
        carbon: '纯黑底，OLED 屏上只剩标本身',
        slate: '冷灰底配浅灰标',
        obsidian: '紫黑渐变底配淡紫标',
        'neon-cyan': '近黑底配荧光青',
        matrix: '终端显示器的磷光绿',
  ...
  'zh-TW': {
    ...
    sections: {
      ...
      palette: '調色盤',
      paletteHelp: '強調色與畫布色調；切換會立即生效並儲存在本地。',
      appIcon: '應用圖示',
    ...
    appearance: {
      ...
      appIconHelp: {
        ...
        cyan: '偏青的藍',
        ice: '由淺到深的藍色漸變',
        'pale-inverted': '淡藍底配深藍標',
        ink: '黑底白標，對比最強',
        paper: '白底黑標',
        graphite: '白底黑標，筆尖為灰',
        'pencil-kraft': '鉛筆意象，牛皮紙底',
        'pencil-sky': '鉛筆意象，天藍底',
        'pencil-navy': '鉛筆意象，深藍底',
        alpine: '雪頂山峰，晴空底',
        dusk: '雪頂山峰，黃昏底',
        night: '雪頂山峰，夜色底',
        midnight: '深藍底搭配亮藍標誌，在深色 Dock 上仍保有清楚輪廓',
        carbon: '純黑背景，OLED 螢幕只顯示標誌',
        slate: '冷色石板灰底搭配淺灰標誌',
        obsidian: '紫黑漸層底搭配淡紫標誌',
        'neon-cyan': '近黑底搭配霓虹青',
        matrix: '終端機螢幕的磷光綠',
        magenta: '深紫底搭配洋紅',
        'amber-crt': '早期終端機的琥珀色',
        ...
        gold: '標誌帶有金色漸層',
        chrome: '標誌帶有銀色漸層',
        'mono-black': '純白底黑色標誌，可單色列印',
        'mono-white': '純黑底白色標誌',
        hazard: '黑底黃色標誌，是本組對比最高的款式',
        forest: '綠色背景上的雪頂山峰',
      },
      appIconGroups: {
        mascot: '擬人',
  ...
  en: {
    ...
    sections: {
      ...
      paletteHelp: 'Accent and canvas colors. Changes apply immediately and are saved locally.',
      appIcon: 'App icon',
      appIconHelp:
    ...
    appearance: {
      ...
      paletteHelp: {
        default: 'Maka brand-blue accent',
        onedark: 'Classic dark editor theme',
        'catppuccin-mocha': 'Soft purple dark theme',
        'tokyo-night': 'Deep-blue editor theme',
        nord: 'Cool Nordic colors',
        coral: 'Warm pink and coral accent',
        azure: 'Clean, calm blue accent',
        forest: 'Deep moss and warm honey',
        dusk: 'Deep violet on a cool canvas',
        sand: 'Amber sand and warm ivory',
        mono: 'Pure grayscale without color distraction',
      },
      paletteGroups: { editor: 'Editor themes', product: 'Product colors' },
      appIconLabels: {
        relx: 'RELX',
        default: 'Classic',
        mono: 'Monochrome',
        ...
        cyan: 'Cyan',
        ice: 'Ice',
        'pale-inverted': 'Inverted',
        ink: 'Ink',
        paper: 'Paper',
        graphite: 'Graphite',
        'pencil-kraft': 'Pencil, kraft',
        'pencil-sky': 'Pencil, sky',
        'pencil-navy': 'Pencil, navy',
        alpine: 'Alpine',
        dusk: 'Dusk',
        night: 'Night',
        midnight: 'Midnight',
      ...
      appIconHelp: {
        relx: 'The RELX brand mark',
        default: 'The default Maka mark',
        mono: 'Grayscale, for a quieter dock',
        sky: 'The geometric M mark in brand blue',
        cyan: 'Blue leaning to cyan',
        ice: 'A pale-to-deep blue gradient',
        'pale-inverted': 'A deep blue mark on a pale field',
        ink: 'White on black, the highest contrast',
        paper: 'Black on white',
        graphite: 'Black on white with a grey tip',
        'pencil-kraft': 'The pencil reading, on kraft paper',
        'pencil-sky': 'The pencil reading, on sky blue',
        'pencil-navy': 'The pencil reading, on deep navy',
        alpine: 'A snow-capped peak under clear sky',
        dusk: 'A snow-capped peak at dusk',
        night: 'A snow-capped peak at night',
        midnight: 'A bright mark on deep navy; keeps its edge on a dark dock',
        carbon: 'True black, so an OLED panel shows nothing but the mark',
        slate: 'Pale grey on cool slate',
        obsidian: 'Lilac on a violet-black gradient',
        'neon-cyan': 'Electric cyan on near-black',
        matrix: 'The green of a phosphor terminal',
        magenta: 'Hot pink on deep violet',
        'amber-crt': 'The amber of an early terminal',
        clay: 'Muted terracotta',
        sage: 'Muted grey-green',
        dust: 'Muted dusty rose',
        fog: 'Muted blue-grey',
        sunset: 'An orange-to-pink diagonal',
        amber: 'A dark mark on amber',
        terracotta: 'A brick-red gradient',
        ocean: 'A deep teal gradient',
        moss: 'A deep moss gradient',
        desert: 'A dark mark on desert sand',
        glacier: 'A pale glacial blue',
        gold: 'The mark itself carries a gold gradient',
        chrome: 'The mark itself carries a silver gradient',
        'mono-black': 'Black on pure white; prints in one colour',
        'mono-white': 'White on pure black',
        hazard: 'Yellow on black, the highest contrast in the set',
        forest: 'A snow-capped peak in green',
      },
      appIconGroups: {
        mascot: 'Mascot',
        blue: 'Blues',
      ...
      appIconSplitLabel: 'Use a different icon in dark mode',
      appIconSplitHelp: 'When off, one icon is used in both appearances.',
      appIconTargets: { light: 'Light', dark: 'Dark' },
      appIconCustom: 'Imported icon',
      appIconCustomHelp: 'An image you imported',
