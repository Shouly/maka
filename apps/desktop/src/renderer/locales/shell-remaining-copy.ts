...
const enCopy: ShellRemainingCopy = {
  scheduledTaskActions: {
    ...
    createIncognitoBlocked: 'Scheduled tasks cannot be created while incognito mode is active.',
    ...
    triggerFallback: 'The scheduled task could not be triggered. Try again later.',
    ...
    clearFallback: 'The scheduled-task history could not be cleared. Try again later.',
  ...
  connections: {
    ...
    refreshFallback: 'Model connections are temporarily unavailable. Try again later.',
  },
