...
/**
 * A run of reasoning, as a step: "Thinking…" while live, "Thought process" once
 * done, opening onto the whole text.
 *
 * Deviation: the reference names the step by a short summary it generates, and
 * so drops the first line from the opened text and does not open a one-line
 * block at all. The model gives no summary, and its own first line reads as half
 * a sentence, not a title; the label says what the step is and the opened text
 * is the whole of it.
 */
