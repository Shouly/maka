...
export function InlineRename(props: {
  ...
  return (
    <input
      ...
      className={cn(
        'h-7 w-full min-w-0 rounded-md bg-surface-2 px-1.5 text-[0.8125rem] leading-5 text-text-primary shadow-[var(--field-shadow)] outline-none focus-visible:shadow-[var(--sidebar-focus-shadow)]',
        props.className,
      )}
    />
  );
