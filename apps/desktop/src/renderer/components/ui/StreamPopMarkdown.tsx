 ...
 */
export default function StreamPopMarkdown({ children, className, noPadding = false, variant, onOpenExternal }: { children: string; className?: string; noPadding?: boolean; variant?: 'default' | 'muted'; onOpenExternal?: (url: string) => void }) {
  ...
  return useMemo(
    () => (
      <div style={{ display: 'contents', '--stream-pop-duration': `${FADE_MS}ms` } as React.CSSProperties}>
