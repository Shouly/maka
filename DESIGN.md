...
colors:
  brand-mark: "#71a8fd"
  accent-light: "oklch(0.62 0.16 255)"
  accent-dark: "oklch(0.72 0.12 254)"
  primary: "oklch(0.48 0.16 255)"
  accent-solid-dark: "oklch(0.76 0.12 254)"
  on-accent-light: "#ffffff"
  on-accent-dark: "#171717"
  surface-raised-light: "oklch(1 0.003 106)"
  surface-base-light: "oklch(0.975 0.003 106)"
  surface-sunken-light: "oklch(0.945 0.003 106)"
  ink-light: "oklch(0.15 0.002 95)"
  surface-raised-dark: "oklch(0.215 0.003 107)"
  surface-overlay-dark: "oklch(0.233 0.003 107)"
  surface-base-dark: "oklch(0.19 0.003 107)"
  surface-sunken-dark: "oklch(0.15 0.003 107)"
  ink-dark: "oklch(0.95 0.004 95)"
  ...
  warning-light: "oklch(0.50 0.15 75)"
  warning-dark: "oklch(0.72 0.15 76)"
