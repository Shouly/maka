...
export const TUI_COPY_RESOURCES = {
  ...
  'primary-guidance': {
    en: {
      ...
      commands: {
        ...
        skill: 'Invoke a skill (or type /<name>)',
        swarm: 'Show, enable, disable, or run one Swarm turn',
        thinking: 'Set thinking level',
        tasks: 'Show the current session task list',
  ...
  skills: {
    en: {
      ...
      usage: 'Usage: /skill, or type /<name> in a message',
      noneAvailable: 'No skills are available to invoke right now.',
    },
    'zh-CN': {
      pickerTitle: '调用技能',
      usage: 'Usage: /skill，或直接在消息中输入 /<name>',
      noneAvailable: '当前没有可调用的技能。',
    },
    'zh-TW': {
      pickerTitle: '呼叫技能',
      usage: 'Usage: /skill，或直接在訊息中輸入 /<name>',
