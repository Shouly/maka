...
function renderAgentGraphSupervisorWakePrompt(
  ...
  return [
    ...
    'Inspect the graph with ViewAgentGraph. Read child results with AgentOutput view=result; use raw event views only for narrow diagnostics.',
    'Then either schedule the next work with UpdateAgentGraph or finish the graph with the selected result record IDs.',
    'If you schedule more work and no immediate supervisor decision remains, call YieldAgentGraph. Do not poll or sleep while operators execute.',
