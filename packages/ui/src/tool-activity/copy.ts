...
const TOOL_ACTIVITY_COPY = {
  'zh-CN': {
    ...
    requiresBypass: {
      title: '当前权限模式下无法执行',
      description: '此操作无法在沙箱内执行，需要更高的权限模式。',
      errorMessage: '当前权限模式下无法执行。此操作无法在沙箱内执行，需要更高的权限模式。',
      action: '切换并重试',
      pending: '正在切换…',
    },
    computer: {
  ...
  'zh-TW': {
    ...
    requiresBypass: {
      title: '目前權限模式下無法執行',
      description: '此操作無法在沙箱內執行，需要更高的權限模式。',
      errorMessage: '目前權限模式下無法執行。此操作無法在沙箱內執行，需要更高的權限模式。',
      action: '切換並重試',
      pending: '正在切換…',
    },
    computer: {
  ...
  en: {
    ...
    requiresBypass: {
      title: 'Not available in this permission mode',
      description: 'This action cannot run inside the sandbox and needs a higher permission mode.',
      errorMessage: 'Not available in this permission mode. This action cannot run inside the sandbox and needs a higher permission mode.',
